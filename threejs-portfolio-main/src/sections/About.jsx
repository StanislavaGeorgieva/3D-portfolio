...
const About = () => {
 ...
 {/*      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        ...
        <div className='xl:col-span-1 xl:rol-span-2'>
          <div className='grid-container'>
            <img src="assets/grid4.png" alt="grid-4" className="w-full m:h-[126px] sm:h-[266px] h-fit object-contain sm:object-top" />
            <div className='space-y-2'>
              <p className='grid-subtext text-center'>Contact me</p>
              <div className='copy-container' onClick={handleCopy}>
              <img src={hasCopied ? 'assets/tick.svg' : 'assets/copy.svg'} alt="copy" />
              <p className='lg:text-2xl md:text-xl font medium text-gray-gradient text-white'>miss_stanislava@yahoo.com</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            <img src="assets/screen1.png" alt="grid-2" className="w-full sm:h-[276px] h-fit object-contain" />
